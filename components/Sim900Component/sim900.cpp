...
void Sim900Component::setup() {
  register_service(&Sim900Component::dial, "makeCall", {"recipient"});
  register_service(&Sim900Component::connect, "answerCall");
  register_service(&Sim900Component::disconnect, "terminateCall");
  register_service(&Sim900Component::send_sms, "send_sms", {"recipient", "message"});
}
